(function(window){
    ...
    Seed.prototype = {
        ...
        drawText: function() {
            // No dibujar texto si ya se hizo click
            if (window.textHidden) return;
            ...
            ctx.fillText("Will you be my valentine?", 23, 16);
            ctx.restore();
        },
        clear: function() {
            var ctx = this.tree.ctx, cirle = this.cirle;
        ...
        clearText: function() {
            ...
            // Limpiar el área donde está el texto y la flecha
            ctx.clearRect(point.x - 50, point.y - 50, 200 * scale, 50 * scale);
        },
        hover: function(x, y) {
